...
const Footer = () => {
	return (
  <>
		<footer className="footer p-10 bg-[#0a0c3d] text-white gap-4 grid-cols-4 ">
  <div>
  ...
  <div>
    ...
    <a className="link link-hover">Selling on ideaBox</a>
	<a className="link link-hover">Buying on Fiverr</a>
	</div>
  <div>
    <span className="footer-title grid  ">Social</span> 
...
<footer className="footer p-10 bg-[#0a0c3d] text-white gap-4 grid-cols-4 flex flex-col items-center justify-center">
  <div>
        <hr class="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
        <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">ideaBox™</a>. All Rights Reserved.</span>
  </div>
</footer>
