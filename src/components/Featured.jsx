			...
			<div className='flex flex-col max-w-7xl'>
				<div className='flex flex-col'>
					...
					<h2 className='text-3xl font-semibold'>
						Created by engineers and founders, we built IdeaBox from the ground
						up to solve our own problem.
					</h2>
					<div className='flex'>
						<a
							href='/about'
				...
				<div className='flex flex-col md:flex-row my-8 gap-5'>
					<div className='flex flex-col gap-4 bg-[#0a0c3d] rounded-xl border border-slate-800 p-5'>
						...
						<p className='opacity-75'>
							We are a team of experts, and know all the pain points involved
							with search of project. We’ve painstakingly built the freelancing
