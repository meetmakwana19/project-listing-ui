...
function ProjectDetails() {
  ...
  return (
    <div className="flex flex-col max-w-screen-sm md:max-w-none lg:max-w-none items-center justify-center mx-3 relative">
      <Container>
        <div className="flex w-full items-center justify-start flex-col md:flex-row relative">
          ...
          <div className="flex flex-col w-full md:w-auto justify-start items-start  md:ml-0">
            ...
            {/* Domain */}
            <Link href="/organizations/" className="text-accent px-6 my-2 text-base font-medium underline">
              Posted by
              {' '}
        ...
        <div className="flex flex-col w-full border-t py-3 px-6 gap-4">
          ...
          <div className="flex flex-wrap">
            <ul className="flex flex-wrap  gap-2 capitalize text-accent">
              <li
                className="border border-slate-300 px-2 py-1 bg-accent/10 text-sm rounded-2xl"
              >
                {project?.techStack}
              </li>
            </ul>
      ...
      {/* Apply Button */}
      <div
        className="flex md:relative 2xl:absolute 2xl:w-96 md:w-4/5 2xl:bg-transparent 2xl:-top-[79%] 2xl:right-[21%] fixed bottom-0 bg-white gap-2 w-full border-t md:border-0 md:bottom-4 border-slate-300 py-2 items-center justify-center z-10 px-3"
      >
