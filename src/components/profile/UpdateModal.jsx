...
function UpdateModal({ developer, setDeveloper }) {
  ...
  const handleSkills = (event) => {
    ...
    setDeveloper({ ...developer, [name]: name === "skills" ? value.split(", ") : value });
  };
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            className="w-full my-6 mr-0 ml-0 relative space-y-8 h-[60vh] overflow-y-scroll scroll-smooth z-10 scrollbar px-3"
          >
        ...
        <form method="dialog">
          <button type="button" className="modalbackdrop">close</button>
        </form>
      </dialog>
    </>
  );
